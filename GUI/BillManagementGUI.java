...
public class BillManagementGUI extends JPanel {
    ...
    // Refresh the building list and other dependent UI components after changes
        refreshBuildingList();
        refreshFloorList();
        refreshRoomList();
        viewFilteredBills(); // Refresh the table view with the updated data
        clearForm(); // Clear the form for a fresh start
    }
}